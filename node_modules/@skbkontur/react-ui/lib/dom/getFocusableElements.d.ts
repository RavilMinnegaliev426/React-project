 ...
 */
export declare const getFocusableElements: (parent?: Document | Element | null) => HTMLElement[];
/**
 ...
 */
export declare const getFirstFocusableElement: (parent?: Document | Element | null) => HTMLElement | null;
/**
 ...
 */
export declare const getNextFocusableElement: (current: HTMLElement, parent?: Document | Element | null, recursive?: boolean) => HTMLElement | null;
/**
 ...
 *
 */
export declare const getClosestFocusableElement: (current: HTMLElement | null) => HTMLElement | null;
