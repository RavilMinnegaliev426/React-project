"use strict";var _interopRequireWildcard = require("@babel/runtime/helpers/interopRequireWildcard");var _interopRequireDefault = require("@babel/runtime/helpers/interopRequireDefault");exports.__esModule = true;exports.ScrollContainer = void 0;var _inheritsLoose2 = _interopRequireDefault(require("@babel/runtime/helpers/inheritsLoose"));var _react = _interopRequireDefault(require("react"));
...
var SCROLL_HIDDEN = _utils.isChrome || _utils.isOpera || _utils.isSafari;var
...
ScrollContainer = /*#__PURE__*/function (_React$Component) {(0, _inheritsLoose2.default)(ScrollContainer, _React$Component);function ScrollContainer() {var _this;for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {args[_key] = arguments[_key];}_this = _React$Component.call.apply(_React$Component, [this].concat(args)) || this;_this.
    ...
    reflow = function () {
      ...
      if (scrollActive) {
        ...
        if (_this.state.scrollSize !== scrollSize || _this.state.scrollPos !== scrollPos) {var
          _scrollState = _this.state.scrollState;
      ...
      _this.setHover(false);
    };return _this;}var _proto = ScrollContainer.prototype;_proto.componentDidMount = function componentDidMount() {this.reflow();};_proto.componentDidUpdate = function componentDidUpdate(prevProps) {if (this.inner) {if (prevProps.preventWindowScroll && !this.props.preventWindowScroll) {this.inner.removeEventListener('wheel', this.handleInnerScrollWheel);}if (!prevProps.preventWindowScroll && this.props.preventWindowScroll) {this.inner.addEventListener('wheel', this.handleInnerScrollWheel, { passive: false });}}this.reflow();};_proto.render = function render() {var state = this.state;var props = this.props;var scroll = null;if (state.scrollActive) {var _cn;var scrollClass = (0, _classnames.default)((_cn = {}, _cn[_ScrollContainer.jsStyles.scroll()] = true, _cn[_ScrollContainer.jsStyles.scrollInvert()] = Boolean(props.invert), _cn[_ScrollContainer.jsStyles.scrollHover()] = state.hover || state.scrolling, _cn));var scrollStyle = { top: state.scrollPos, height: state.scrollSize };scroll = _react.default.createElement("div", { ref: this.refScroll, className: scrollClass, style: scrollStyle, onMouseDown: this.handleScrollMouseDown });}var innerStyle = { marginRight: this.getMarginRight(), maxHeight: props.maxHeight, paddingRight: PADDING_RIGHT, scrollBehavior: props.scrollBehaviour };return _react.default.createElement("div", { className: _ScrollContainer.jsStyles.root(), onMouseMove: this.handleMouseMove, onMouseLeave: this.handleMouseLeave }, scroll, _react.default.createElement("div", { "data-tid": "ScrollContainer__inner", className: _ScrollContainer.jsStyles.inner(), style: innerStyle, ref: this.refInner, onScroll: this.handleNativeScroll }, props.children));} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          * @public
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          */;_proto.scrollTo = function scrollTo(element) {if (!element || !this.inner) {return;}var maxScroll = element.offsetTop;if (this.inner.scrollTop > maxScroll) {this.inner.scrollTop = maxScroll;return;}var minScroll = element.offsetTop + element.scrollHeight - this.inner.offsetHeight;if (this.inner.scrollTop < minScroll) {this.inner.scrollTop = minScroll;}} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  */;_proto.scrollToTop = function scrollToTop() {if (!this.inner) {return;}this.inner.scrollTop = 0;} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        * @public
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        */;_proto.scrollToBottom = function scrollToBottom() {if (!this.inner) {return;}this.inner.scrollTop = this.inner.scrollHeight - this.inner.offsetHeight;};_proto.setHover = function setHover(hover) {if (this.state.hover !== hover) {this.setState({ hover: hover });}};_proto.
  ...
  getMarginRight = function getMarginRight() {
    return -1 * (PADDING_RIGHT + (SCROLL_HIDDEN ? 0 : (0, _getScrollWidth.getScrollWidth)()));
