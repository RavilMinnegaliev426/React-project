...
var _TextWidthHelper = require("./TextWidthHelper");var _dec, _class, _class2, _temp;var
...
var DefaultState = {
  ...
  loading: false,
  preventBlur: false,
  inputValueWidth: 20 };exports.DefaultState = DefaultState;


var defaultToKey = function defaultToKey(item) {return item.toString();};
var identity = function identity(item) {return item;};
var defaultRenderToken = function defaultRenderToken(item, _ref) {var isActive = _ref.isActive,onClick = _ref.onClick,onRemove = _ref.onRemove,disabled = _ref.disabled;return (
    _react.default.createElement(_Token.Token, { key: item.toString(), isActive: isActive, onClick: onClick, onRemove: onRemove, disabled: disabled },
    item));};var




TokenInput = (_dec = (0, _decorators.locale)('TokenInput', _locale.TokenInputLocaleHelper), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_React$PureComponent) {(0, _inheritsLoose2.default)(TokenInput, _React$PureComponent);function TokenInput() {var _this;for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {args[_key] = arguments[_key];}_this = _React$PureComponent.call.apply(_React$PureComponent, [this].concat(args)) || this;_this.
    ...
    inputRef = function (node) {return _this.input = node;};_this.
    tokensInputMenuRef = function (node) {return _this.tokensInputMenu = node;};_this.
    textHelperRef = function (node) {return _this.textHelper = node;};_this.
    wrapperRef = function (node) {return _this.wrapper = node;};_this.

    dispatch = function (action, cb) {
      _this.setState(function (prevState) {return (0, _TokenInputReducer.tokenInputReducer)(prevState, action);}, cb);
    };_this.
    ...
    isBlurToMenu = function (event) {
      if (_this.menuRef) {
        var menu = (0, _reactDom.findDOMNode)(_this.menuRef);
    ...
    handleInputPaste = function (event) {
      ...
      if (delimiters.some(function (delimiter) {return paste.includes(delimiter);})) {
        ...
        for (var _iterator = delimiters, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {var _ref2;if (_isArray) {if (_i >= _iterator.length) break;_ref2 = _iterator[_i++];} else {_i = _iterator.next();if (_i.done) break;_ref2 = _i.value;}var delimiter = _ref2;
    ...
    tryGetItems = /*#__PURE__*/function () {var _ref3 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(query) {var autocompleteItems, autocompleteItemsUnique;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:if (query === void 0) {query = '';}if (!(
                _this.props.getItems && (_this.state.inputValue !== '' || !_this.props.hideMenuIfEmptyInputValue))) {_context.next = 9;break;}
                ...
                autocompleteItemsUnique = autocompleteItems.filter(
                function (item) {return !_this.hasValueInItems(_this.props.selectedItems, item);});
                ...
                }case 9:case "end":return _context.stop();}}}, _callee);}));return function (_x) {return _ref3.apply(this, arguments);};}();_this.
    ...
    handleInputKeyDown = function (e) {
      ...
      if (_this.type !== TokenInputType.WithReference && ((0, _identifiers.isKeyEnter)(e) || _this.delimiters.includes(e.key))) {
        e.preventDefault();
      ...
      switch (true) {
        ...
        case (0, _identifiers.isKeyArrowVertical)(e):
          e.preventDefault();
          if (_this.menuRef) {
            if ((0, _identifiers.isKeyArrowUp)(e)) {
              _this.menuRef.up();
            } else {
              _this.menuRef.down();
            }
    ...
    handleWrapperKeyDown = function (e) {
      switch (true) {
        ...
        case (0, _identifiers.isKeyArrowHorizontal)(e):
          _this.handleWrapperArrows(e);
          break;
        case (0, _identifiers.isKeyEscape)(e):
          _this.wrapper.blur();
          break;
        case (0, _identifiers.isShortcutSelectAll)(e):
          e.preventDefault();
          _this.dispatch({
    ...
    handleWrapperArrows = function (e) {
      ...
      var isRightEdge = activeItemIndex === _this.props.selectedItems.length - 1 && (0, _identifiers.isKeyArrowRight)(e);
    ...
    handleValueChange = function (item) {
    ...
    handleRemoveToken = function (item) {
      _this.props.onValueChange(_this.props.selectedItems.filter(function (_) {return !(0, _lodash.default)(_, item);}));
    ...
    handleTokenClick = function (event, itemNew) {
    ...
    handleChangeInputValue = function (event) {
    ...
    renderTokenFields = function () {
      return _this.props.selectedItems.map(_this.renderToken);
    };_this.

    renderToken = function (item) {var _this$props =
      _this.props,_this$props$renderTok = _this$props.renderToken,renderToken = _this$props$renderTok === void 0 ? defaultRenderToken : _this$props$renderTok,disabled = _this$props.disabled;
    ...
    renderAddButton = function (value) {if (value === void 0) {value = _this.state.inputValue;}
      ...
      _this.locale,addButtonComment = _this$locale.addButtonComment,addButtonTitle = _this$locale.addButtonTitle;

      return (
        _react.default.createElement(_MenuItem.MenuItem, { onClick: _this.handleAddItem, comment: addButtonComment, key: "renderAddButton" },
        addButtonTitle, " ", value));


    };return _this;}var _proto = TokenInput.prototype;_proto.componentDidMount = function componentDidMount() {this.updateInputTextWidth();document.addEventListener('copy', this.handleCopy);if (this.props.autoFocus) {this.focusInput();}};_proto.componentDidUpdate = function componentDidUpdate(prevProps, prevState) {if (prevState.inputValue !== this.state.inputValue) {this.updateInputTextWidth();}if (prevState.activeTokens.length === 0 && this.state.activeTokens.length > 0) {this.dispatch({ type: 'SET_AUTOCOMPLETE_ITEMS', payload: undefined });}if (prevProps.selectedItems.length !== this.props.selectedItems.length) {LayoutEvents.emit();}if (!this.isCursorVisibleForState(prevState) && this.isCursorVisible) {this.tryGetItems(this.state.inputValue);}};_proto.componentWillUnmount = function componentWillUnmount() {document.removeEventListener('copy', this.handleCopy);};_proto.render = function render() {var _this2 = this;return _react.default.createElement(_ThemeContext.ThemeContext.Consumer, null, function (theme) {_this2.theme = theme;return _this2.renderMain();});};_proto.renderMain = function renderMain() {var _cn, _cn2;if (this.type !== TokenInputType.WithoutReference && !this.props.getItems) {throw Error('Missed getItems for type ' + this.type);}var _this$props2 = this.props,selectedItems = _this$props2.selectedItems,width = _this$props2.width,maxMenuHeight = _this$props2.maxMenuHeight,error = _this$props2.error,warning = _this$props2.warning,disabled = _this$props2.disabled,placeholder = _this$props2.placeholder,renderItem = _this$props2.renderItem,renderNotFound = _this$props2.renderNotFound,hideMenuIfEmptyInputValue = _this$props2.hideMenuIfEmptyInputValue,onMouseEnter = _this$props2.onMouseEnter,onMouseLeave = _this$props2.onMouseLeave;var _this$state = this.state,activeTokens = _this$state.activeTokens,inFocus = _this$state.inFocus,inputValueWidth = _this$state.inputValueWidth,inputValue = _this$state.inputValue,autocompleteItems = _this$state.autocompleteItems,loading = _this$state.loading;var showMenu = this.type !== TokenInputType.WithoutReference && this.isCursorVisible && activeTokens.length === 0 && (inputValue !== '' || !hideMenuIfEmptyInputValue);var inputInlineStyles = { // вычисляем ширину чтобы input автоматически перенёсся на следующую строку при необходимости
      width: Math.max(50, inputValueWidth + 7), // input растягивается на всю ширину чтобы placeholder не обрезался
      ...
      caretColor: this.isCursorVisible ? undefined : 'transparent' };var theme = this.theme;var labelClassName = (0, _classnames.default)(_TokenInput.jsStyles.label(theme), (_cn = {}, _cn[_TokenInput.jsStyles.labelFocused(theme)] = !!inFocus, _cn[_TokenInput.jsStyles.error(theme)] = !!error, _cn[_TokenInput.jsStyles.warning(theme)] = !!warning, _cn[_TokenInput.jsStyles.labelDisabled(theme)] = !!disabled, _cn));var inputClassName = (0, _classnames.default)(_TokenInput.jsStyles.input(theme), (_cn2 = {}, _cn2[_TokenInput.jsStyles.inputDisabled(theme)] = !!disabled, _cn2));return _react.default.createElement("div", { onMouseEnter: onMouseEnter, onMouseLeave: onMouseLeave }, _react.default.createElement(_TextWidthHelper.TextWidthHelper, { ref: this.textHelperRef, text: inputValue }), _react.default.createElement("label", { ref: this.wrapperRef, style: { width: width }, className: labelClassName, onMouseDown: this.handleWrapperMouseDown, onMouseUp: this.handleWrapperMouseUp }, this.renderTokenFields(), _react.default.createElement("input", { type: "text", ref: this.inputRef, value: inputValue, style: inputInlineStyles, autoComplete: "off", spellCheck: false, disabled: disabled, className: inputClassName, placeholder: selectedItems.length > 0 ? undefined : placeholder, onFocus: this.handleInputFocus, onBlur: this.handleInputBlur, onChange: this.handleChangeInputValue, onKeyDown: this.handleKeyDown, onPaste: this.handleInputPaste }), showMenu && _react.default.createElement(_TokenInputMenu.TokenInputMenu, { ref: this.tokensInputMenuRef, items: autocompleteItems, loading: loading, opened: showMenu, maxMenuHeight: maxMenuHeight, anchorElement: this.input, renderNotFound: renderNotFound, renderItem: renderItem, onValueChange: this.handleValueChange, renderAddButton: this.renderAddButton })));} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       * Сбрасывает введенное пользователем значение
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       * @public
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       */;_proto.reset = function reset() {this.dispatch({ type: 'RESET' });};_proto.isCursorVisibleForState = function isCursorVisibleForState(state) {return state.inFocus && (state.inputValue !== '' || state.activeTokens.length === 0);};_proto.updateInputTextWidth = function updateInputTextWidth() {if (this.textHelper) {var inputValueWidth = this.textHelper.getTextWidth();this.dispatch({ type: 'SET_INPUT_VALUE_WIDTH', payload: inputValueWidth }, LayoutEvents.emit);}};_proto.moveFocusToLastToken = function moveFocusToLastToken() {var items = this.props.selectedItems;if (this.state.inputValue === '' && items && items.length > 0) {this.dispatch({ type: 'SET_ACTIVE_TOKENS', payload: items.slice(-1) });}};(0, _createClass2.default)(TokenInput, [{ key: "showAddItemHint", get: function get() {var items = this.state.autocompleteItems;var value = this.props.valueToItem(this.state.inputValue);if (items && this.hasValueInItems(items, value)) {return false;}var selectedItems = this.props.selectedItems;if (selectedItems && this.hasValueInItems(selectedItems, value)) {return false;}if (this.type === TokenInputType.Combined && this.state.inputValue !== '') {return true;}} }, { key: "type", get: function get() {return this.props.type ? this.props.type : TokenInputType.WithReference;} }, { key: "delimiters", get: function get() {return this.props.delimiters ? this.props.delimiters : [','];} }, { key: "menuRef", get: function get() {return this.tokensInputMenu && this.tokensInputMenu.getMenuRef();} }, { key: "isCursorVisible", get: function get() {return this.isCursorVisibleForState(this.state);} }]);return TokenInput;}(_react.default.PureComponent), _class2.__KONTUR_REACT_UI__ = 'TokenInput', _class2.defaultProps = { selectedItems: [], renderItem: identity, renderValue: identity, valueToString: identity, valueToItem: function valueToItem(item) {return item;}, toKey: defaultToKey, onValueChange: function onValueChange() {return void 0;}, width: 250, onBlur: _utils.emptyHandler, onFocus: _utils.emptyHandler, onMouseEnter: _utils.emptyHandler, onMouseLeave: _utils.emptyHandler }, _temp)) || _class);exports.TokenInput = TokenInput;