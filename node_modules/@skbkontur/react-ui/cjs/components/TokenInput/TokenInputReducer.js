"use strict";exports.__esModule = true;exports.tokenInputReducer = tokenInputReducer;exports.TokenActions = void 0;var _TokenInput = require("./TokenInput");
...
var TokenActions = {
  ...
  RESET: 'RESET' };exports.TokenActions = TokenActions;




function tokenInputReducer(
state,
action)
{
  ...
  switch (action.type) {
    ...
    case TokenActions.RESET:{
        return _TokenInput.DefaultState;
      }
