"use strict";exports.__esModule = true;exports.darkTheme = void 0;var _ThemeFactory = require("../../lib/theming/ThemeFactory");

var darkTheme = _ThemeFactory.ThemeFactory.create({
  brandXLight: '#cae5f5',
  brandLight: '#3094d0',
  brand: '#1e79be',
  brandDark: '#1363a0',
  ...
  specificityLevel: '0',
  textareaBg: 'none',
  textareaColor: 'inherit' });exports.darkTheme = darkTheme;