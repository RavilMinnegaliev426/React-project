...
export declare function filterProps<Props extends Record<string, any>, Allowed extends Record<string, boolean>, Specific extends Filter<keyof Props, True<Allowed>>, Optional extends Filter<keyof Props, AmbiguousBool<Allowed>>, Result extends {
