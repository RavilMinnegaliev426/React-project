...
InternalDateValidator = /*#__PURE__*/function () {function InternalDateValidator() {}InternalDateValidator.
  ...
  checkLimits = function checkLimits(_ref2,

  type)
  {var year = _ref2.year,month = _ref2.month,date = _ref2.date;
    if (type !== undefined) {
      var value =
      type === _types.InternalDateComponentType.Year ? year : type === _types.InternalDateComponentType.Month ? month : date;
    ...
    return (
      ...
      month >= _InternalDateGetter.InternalDateGetter.getDefaultMin(_types.InternalDateComponentType.Month) &&
      month <= _InternalDateGetter.InternalDateGetter.getDefaultMax(_types.InternalDateComponentType.Month) &&
      date >= _InternalDateGetter.InternalDateGetter.getDefaultMin(_types.InternalDateComponentType.Date) &&
      date <= _InternalDateGetter.InternalDateGetter.getDefaultMax(_types.InternalDateComponentType.Date));

  };InternalDateValidator.

  compareWithNativeDate = function compareWithNativeDate(_ref3) {var year = _ref3.year,month = _ref3.month,date = _ref3.date;
  ...
  checkRangeFully = function checkRangeFully(date, startDate, endDate) {
  ...
  startComponents,
  endComponents)
  {var year = _ref4.year,month = _ref4.month,date = _ref4.date;
    if (startComponents === null && endComponents === null) {
      return true;
    }var _ref5 =

    startComponents || {},_ref5$year = _ref5.year,startYear = _ref5$year === void 0 ? -Infinity : _ref5$year,_ref5$month = _ref5.month,startMonth = _ref5$month === void 0 ? -Infinity : _ref5$month,_ref5$date = _ref5.date,startDate = _ref5$date === void 0 ? -Infinity : _ref5$date;var _ref6 =
    endComponents || {},_ref6$year = _ref6.year,endYear = _ref6$year === void 0 ? Infinity : _ref6$year,_ref6$month = _ref6.month,endMonth = _ref6$month === void 0 ? Infinity : _ref6$month,_ref6$date = _ref6.date,endDate = _ref6$date === void 0 ? Infinity : _ref6$date;
  ...
  testParseToNumber = function testParseToNumber(value) {
    return value !== null && (typeof value === 'number' || !Number.isNaN(parseInt(value, 10)));
  };InternalDateValidator.

  isEqualDateValues = function isEqualDateValues(a, b) {
    return a.toInternalString() === b.toInternalString();
  };InternalDateValidator.

  isEqualDateFormats = function isEqualDateFormats(a, b) {
    return a.getOrder() === b.getOrder() && a.getSeparator() === b.getSeparator();
  };return InternalDateValidator;}();exports.InternalDateValidator = InternalDateValidator;