...
export declare enum InternalDateOrder {
    DMY = "DMY",
    YMD = "YMD",
    MDY = "MDY"
}
export declare enum InternalDateSeparator {
    Slash = "/",
    Dot = ".",
    Dash = "-",
    Space = " "
}
export declare enum InternalDateComponentType {
    Date = 0,
    Month = 1,
    Year = 2,
    All = 3,
...
export declare type InternalDateTypesOrder = [InternalDateComponentType, InternalDateComponentType, InternalDateComponentType];
export declare type InternalDateComponent = number | null;
export declare type InternalDateComponentRaw = number | string | null;
...
export declare enum InternalDateValidateCheck {
    NotNull = 0,
    Number = 1,
    Limits = 2,
    Native = 3,
...
export declare function isInternalDateValidateCheck(value: unknown): value is InternalDateValidateCheck;
export declare enum InternalDateFirstDayWeek {
    Monday = 0,
    Sunday = 1,
    Saturday = 2
}
export declare enum InternalDateDayWeek {
    Monday = 1,
    Tuesday = 2,
    Wednesday = 3,
    Thursday = 4,
