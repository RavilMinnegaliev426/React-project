...
export declare class DatePicker extends React.Component<DatePickerProps<DatePickerValue>, DatePickerState> {
    ...
    UNSAFE_componentWillReceiveProps(nextProps: DatePickerProps<DatePickerValue>): void;
    /**
     * @public
     */
    blur(): void;
