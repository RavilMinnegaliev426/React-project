...
export declare class Tooltip extends React.PureComponent<TooltipProps, TooltipState> {
    ...
    static propTypes: {
        children(props: TooltipProps, propName: "className" | "children" | "pos" | "onOpen" | "anchorElement" | "disableAnimations" | "useWrapper" | "closeButton" | "render" | "trigger" | "onCloseClick" | "onCloseRequest" | "allowedPositions", componentName: string): void;
    };
    static defaultProps: {
        pos: string;
        trigger: string;
    ...
    UNSAFE_componentWillReceiveProps(nextProps: TooltipProps): void;
